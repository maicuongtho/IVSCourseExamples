...
<body>
 <div id="wrapper">
    ...
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin//vendor/metisMenu/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin//vendor/raphael/raphael.min.js"></script>
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin//vendor/morrisjs/morris.min.js"></script>
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin//data/morris-data.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="${pageContext.request.contextPath}/tainguyen/sb-admin//dist/js/sb-admin-2.js"></script>
</body>
</html>